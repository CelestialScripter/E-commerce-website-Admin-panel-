...
<head>
    ...
    <title>QCS Admin | Manage Subcategory</title>
    <!-- Custom CSS -->
...
<body class="skin-default-dark fixed-layout">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Quick Cart Admin</p>
        </div>
    </div>
    <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body overflow-auto">
                                <h5 class="card-title m-b-10">Manage Subcategories</h5>
                    ...
                    while($fetch = mysqli_fetch_array($sql))
                 {
                              ...
                              $sub_id = $fetch['sub_id'];
                              $subname = $fetch['sub_cat_name'];
                              $subdesc= $fetch['sub_cat_desc'];
                             echo "<tr>
                                 <td value='".$sub_id."'>".$sub_id."</td>
                                 <td>$subname</td>
                                 <td>$subdesc</td>
                                 <td><a href='Edit-$sub_id'>Edit</a>
                                        ...
                                        <form class="modal-content form-horizontal" id="editor">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group required row">
                                                    <label for="Subcategory Name" class="col-sm-3 control-label">Subcategory Name</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="Subcategory Name" name="Subcategory Name" placeholder="Subcategory Name" required>
                                                    </div>
                                                </div>
                                                <div class="form-group required row">
                                                    <label for="Subcategory Description" class="col-sm-3 control-label">Subcategory Description</label>
                                                    <div class="col-sm-9">
                                                          <textarea class="form-control" id="exampleTextarea" rows="3" placeholder="Subcategory Description"></textarea>
                                            </div>
                                                    </div>
                                                </div>
