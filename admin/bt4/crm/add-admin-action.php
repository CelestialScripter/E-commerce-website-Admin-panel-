...
else
{
	...
	$verify_email_query = " SELECT email FROM adminlogin WHERE email='$email' ";
	...
	if( $email_rows_ret < 1 )
	{
	 ...
	 if(move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)){
					...
					// REGISTER
					// INSERT INTO DB
					$insert_reg_query = " INSERT INTO adminlogin (`first_name`,`last_name`,`DOB`,`email`,`mobile_no`,`profile_pic`,`gender`,`password`)
					VALUES('$first_name', '$last_name', '$DOB', '$email', '$mobile_no', '$targetFilePath','$gender', '$password' ) ";
