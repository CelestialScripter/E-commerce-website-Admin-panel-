...
<head>
    ...
    <title>Quick Cart Stores|Add User
    </title>
    <!-- Custom CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Add Users</h4>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-material form-horizontal m-t-30" method="post" action="add_user_action.php" enctype="multipart/form-data" >
                                    <div class="form-body">
                                    <div class="card-body">
                                        <div class="row pt-3">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="first_name" class="form-control" placeholder="" name="first_name" required>
                                                 </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="tel"  id="mobile_no" name="mobile_no" required>
                                        </div>
                                    </div>
                                ...
                                <div class="form-check">
                                  ...
                                  <label class="form-check-label" for="customCheck1">is_active</label>
                                </div>
                            ...
                            <div class="col-md-6">
                                    ...
                                    <button type="submit"  class="btn btn-info text-white" id="btn-reg">Submit</button>
                               </div>
                               </div>
                                </div>
                            </form>
