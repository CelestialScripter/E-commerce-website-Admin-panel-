           ...
           // $Id = $_GET['varname'];                                                
                                        ...
                                        $postID =   $_GET['id'];
                                                 if (!isset($postID)) { 
                                                   ...
                                                   header('Location: mng_subcategory');
                                                }

                                                else{

                                                    $details= mysqli_query($mysqli, "select * from sub_category where sub_id = '".$postID."' ") or die(mysqli_error());
                                                     ...
                                                     while($fetch = mysqli_fetch_array($details))
                                                         {
                                                          ...
                                                          $sub_id = $fetch['sub_id'];
                                                             $sub_cat_name= $fetch['sub_cat_name']; 
                                                          $sub_cat_desc= $fetch['sub_cat_desc'];
                                                          }
                                                        }
     ?>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Edit Subcategory</h4>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-material form-horizontal m-t-30" method="post" action="up_subcat_action.php">
                                    <div class="form-body">
                                        <div class="row pt-3">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label > <span class="help"> </span></label>
                                         <input type="text" id="sub_cat_name" name="sub_cat_name" class="form-control" value="<?=$sub_cat_name; ?>">
                                     </div>
                                 </br>
                             </br>
                              <h2>Edit Subcategory Description</h2>
                                     <textarea class="form-control" type="text" id="sub_cat_desc" name="sub_cat_desc" rows="3"><?=$sub_cat_desc; ?></textarea>
