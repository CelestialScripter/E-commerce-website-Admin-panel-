...
<head>
    ...
    <title>QCS Admin | Manage User</title>
    <!-- Custom CSS -->
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body overflow-auto">
                                <h5 class="card-title m-b-10">Add & Remove Users</h5>
                                <h6 class="card-subtitle m-b-20">You can add or remove rows with Footable </h6>
                    ...
                    $sql = mysqli_query($mysqli, "SELECT * from users ") or die (mysqli_error($mysqli));
                    ...
                    while($fetch = mysqli_fetch_array($sql))
                 {
                             ...
                             echo "<tr>
                                 ...
                                 <td>$gender</td>
                                 <td>$password</td>
                                 <td><a href='editt-$usr_id'>Edit</a>  </td>
                                 <td><a href='delete-$usr_id'>delete</a> </td>
