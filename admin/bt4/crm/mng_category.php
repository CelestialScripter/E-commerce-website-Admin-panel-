...
<head>
    ...
    <title>QCS Admin | Manage Category</title>
    <!-- Custom CSS -->
               ...
               <form method="get">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body overflow-auto">
                                <h5 class="card-title m-b-10">Manage Categories</h5>s
                                <table  class="table" data-paging="true" data-filtering="true" data-sorting="true" data-editing="true" data-state="true">
                    ...
                    while($fetch = mysqli_fetch_array($sql))
                 {
                              ...
                              $cat_id = $fetch['cat_id'];
                              $cat = $fetch['cat_name'];
                              $catd = $fetch['cat_description'];
                             echo "<tr>
                                 <td value='".$cat_id."'>".$cat_id."</td>
                                 <td>$cat</td>
                                 <td>$catd</td>
                                 <td><a href='edit-$cat_id'>Edit</a>
