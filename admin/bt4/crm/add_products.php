...
<body class="skin-default-dark fixed-layout">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-material form-horizontal m-t-30" method="post" action="add-product-action.php" enctype="multipart/form-data">
                                    <div class="form-body">
                                    <div class="card-body">
                                        <div class="row pt-3">
                                            <div class="col-md-6">
     ...
     ?>
                                     ...
                                     <div class="form-group">
                                        <label >Name <span class="help"> </span></label>
                                         <input type="Text" id="it_name" name="it_name" class="form-control" placeholder="Product Name">
                                        </div>
                                     </div>
                             </br>
                                  <h2>Product Description</h2>
                                          <textarea class="form-control" name="it_desc" id="it_desc" rows="3" placeholder="Product Description"></textarea>
                                      </div>
                                  </br>
                                <div class="form-group">
                                    <label class="form-label">Discount <small class="text-muted"></small></label>
                                    <input type="text" id="discount" name="discount" placeholder="Enter Value in %">
                                </div>
                            </br>
  ...
  <div class="form-group">
    <label class="form-label">Pricture of Product</label>
