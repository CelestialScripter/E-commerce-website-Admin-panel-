           ...
           // $Id = $_GET['varname'];                                                
                                        ...
                                        $postID =   $_GET['id'];
                                                 if (!isset($postID)) { 
                                                   ...
                                                   header('Location: mng_category');
                                                }

                                                else{

                                                    $details= mysqli_query($mysqli, "select * from category where cat_id = '".$postID."' ") or die(mysqli_error());
                                                     ...
                                                     while($fetch = mysqli_fetch_array($details))
                                                         {
                                                          ...
                                                          $cat_description= $fetch['cat_description'];
                                                          }
                                                        }
     ?>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-material form-horizontal m-t-30" method="post" action="up_cat_action.php">
                                    <div class="form-body">
                                        <div class="row pt-3">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <label > <span class="help"> </span></label>
                                         <input type="text" id="cat_name" name="cat_name" class="form-control" placeholder="Category name" value="<?=$cat_name; ?>">
                                     </div>
                                 </br>
                             </br>
                              <h2>Edit category Description</h2>
                                     <textarea class="form-control" type="text" id="cat_description" name="cat_description" rows="3" placeholder="Category Description" ><?=$cat_description; ?></textarea>
