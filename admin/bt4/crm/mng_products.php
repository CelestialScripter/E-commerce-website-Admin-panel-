...
<head>
    ...
    <title>QCS Admin | Manage Products</title>
    <!-- Custom CSS -->
...
<body class="skin-default-dark fixed-layout">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body overflow-auto">
                                <h5 class="card-title m-b-10">Manage Products</h5>
    ...
    <?php
                    ...
                    $sql = mysqli_query($mysqli, "SELECT * from items ") or die(mysqli_error($mysqli));
