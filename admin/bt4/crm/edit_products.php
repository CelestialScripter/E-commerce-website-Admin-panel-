           ...
           // $Id = $_GET['varname'];                                                
                                        ...
                                        $postID =   $_GET['id'];
                                                 if (!isset($postID)) { 
                                                   ...
                                                   header('Location: mng_products');
                                                }

                                                else{

                                                    $details= mysqli_query($mysqli, "select * from items where it_id = '".$postID."' ") or die(mysqli_error());
                    
                                                     
                                                     while($fetch = mysqli_fetch_array($details))
                                                         {                                             
                              $it_id = $fetch['it_id'];
                              $it_name = $fetch['it_name'];
                              $it_desc = $fetch['it_desc'];
                              $it_quantity = $fetch['it_quantity'];
                              $discount = $fetch['discount'];
                              $is_active = $fetch['is_active'];
                              $product_pic= $fetch['product_pic'];
                              $price = $fetch['price'];
                              $cat_id = $fetch['cat_id'];
                              $sub_id = $fetch['sub_id'];
...
<body class="skin-default-dark fixed-layout">
    ...
    <div id="main-wrapper">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-material form-horizontal m-t-30" method="post" action="up-product-action.php" enctype="multipart/form-data">
                                    <div class="form-body">
                                    <div class="card-body">
                                        <div class="row pt-3">
                                            <div class="col-md-6">
                                                <label class="form-label">Select Category</label>
                                                    <select class="form-control form-select" data-placeholder="Choose a Category" tabindex="1" id="Category" name="Category">
     ...
     ?>
                                                   ...
                                                   <div class="form-group">
                                                    ...
                                                    <select class="form-control form-select" data-placeholder="Choose a Subcategory"  id="sub_category" name="sub_category">
                                                   
     <?php

                    $sql = mysqli_query($mysqli, "SELECT * from sub_category ") or die(mysqli_error($mysqli));
                    ...
                    while($fetch = mysqli_fetch_array($sql))
                 {
                              ...
                              $cat_id = $fetch['sub_id'];
                              $subcat = $fetch['sub_cat_name'];
                             
                             echo "<option value='".$cat_id."'>" .$subcat."</option>";     
     ...
     ?>
                                     ...
                                     <div class="form-group">
                                        <label >Name <span class="help"> </span></label>
                                         <input type="Text" id="it_name" name="it_name" class="form-control" placeholder="Product Name" value="<?=$it_name;?>">
                                        </div>
                                     </div>
                             </br>
                                  <h2>Product Description</h2>
                                          <textarea class="form-control" name="it_desc" id="it_desc" rows="3" placeholder="Product Description" value="<?=$it_desc;?>" ></textarea>
                                      </div>
                                  </br>
                                <div class="form-group">
                                    <label class="form-label">Discount <small class="text-muted"></small></label>
                                    <input type="text" id="discount" name="discount" placeholder="Enter Value in %" value="<?=$discount;?>">
                                </div>
                            </br>
                           
                               <div class="input-group">
                                <label class="form-label">Price ₦<small class="text-muted"></small>
                                <input type="text" class="form-control" aria-label="Amount (to the nearest dollar)" name="price" id="price" value="<?=$price;?>">
                               </div>
                           </br>
                           <div class="form-group">
                                        <label class="form-label">Quantity</label>
                                    </br>
                                        <select class="form-select" name="it_quantity" id="it_quantity">
                                 ...
                                 <?php 
                                  ...
                                  <input type="checkbox" class="form-check-input" id="is_active" name="is_active" active>
  ...
  <div class="form-group">
    <img src="<?=$product_pic; ?>">
    <label class="form-label">Picture of Product</label>
