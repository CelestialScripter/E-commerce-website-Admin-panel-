...
<head>
    ...
    <title>QCS Admin | Add Subcategory
    </title>
    <!-- Custom CSS -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-material form-horizontal m-t-30" method="post" action="add_subcat_action.php">
                                    <div class="form-body">
                                    <div class="card-body">
                                        <div class="row pt-3">
                                            <div class="col-md-6">
     ...
     ?>
                                  ...
                                  <div class="form-group">
                                       <!--  <label >Name <span class="help"> </span></label> -->
                                         <input type="text" id="sub_cat_name" name="sub_cat_name" class="form-control" >
                                       </div>
                                  </div>
                                 </br>
                             </br>
                                        <h2>Subcategory Description</h2>
                                                <textarea class="form-control" id="sub_cat_desc" name="sub_cat_desc" rows="3" placeholder="Description"></textarea>
                                           </div>
                                            </div>
                                            <button type="submit" class="btn btn-info text-white">Submit</button>
                                        </div>
