                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-material form-horizontal m-t-30" method="post" action="add_cat_action.php">
                                    <div class="form-body">
                                    <div class="card-body">
                                        <div class="row pt-3">
                                            <div class="col-md-6">
                              ...
                              <h2>Category Description</h2>
                               <div class="form-group">
                                     <textarea class="form-control" type="text" id="cat_description" name="cat_description" rows="3" placeholder="Category Description"></textarea>
                              </div>
                                    <button type="submit" class="btn btn-info text-white">Submit</button> </div>
                                    </div>               
